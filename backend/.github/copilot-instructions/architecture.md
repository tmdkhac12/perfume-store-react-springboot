# Project Shape
- This backend is a **modular monolith** (`notes/architecture.txt`): shared persistence in `src/main/java/com/example/perfume_store/domain`, feature logic in `src/main/java/com/example/perfume_store/modules/*`.
