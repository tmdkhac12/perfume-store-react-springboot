...
function LoginForm() {
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div>
        <label
          className="mb-2 ml-1 block text-sm uppercase tracking-[0.1em] text-on-surface-variant"
          htmlFor="username"
        >
          Username or Email
        </label>
      ...
      <div className="pt-2">
        <div className="mx-1 mb-2 flex items-baseline justify-between">
          <label
            className="block text-sm uppercase tracking-[0.1em] text-on-surface-variant"
            htmlFor="password"
          >
            Password
          </label>
