...
const statCards = [
  ...
  },
  {
    ...
    icon: 'shopping_bag',
    borderClassName: 'border-l-surface-tint'
  },
  {
    ...
    icon: 'inventory_2',
    borderClassName: 'border-l-outline-variant'
  }
];
...
const topExhibitions = [
  {
    ...
    sold: '120 sold',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuAQXVK-tMClCRWDNzSQjfIx-y1BdRQTm0WE7mQiTIDB7y57VLyhu7miPU5l1q89-nAASTQXhl8kM3gj9VpfagPVXQ6F2KTG6Jxajg3iqoLXs2iJ61A896PlxSK55KppvKodMkEXFVqS6fqEFKfHQYHEkrukbF7_8Ty-bd26_qm4_xUWsDr93sBpOZoaKT8JXWoBiTFT6lZelVVW2HwUiU0aPOKBIxoYuOy7V0UAYQ1F7oji9I-lpASXf26YtwdYlAoPWJkL9Ds4T6I'
  },
  {
    name: 'Bergamot Blanc',
    category: 'Citrus',
    ...
    sold: '95 sold',
    image:
      'https://lh3.googleusercontent.com/aida-public/AB6AXuBoXNabhVzTYHpIvpNn6zj4yxBaFkR1SxkRzo4Uwas6vzzWBUnAI5f-5ZKaaiAt1FnXwUOhFio_9FfPvcBXwWTwp8HE6e8xq8Z67gtfJ_Zis0Y_YIxee3t-ranwII10pBZwonoSX2boV2zxj69J21QJNzg0h2pxkgiPH0ZZEOgvF308stAKtUUEAAvtSxW7ULnFrBQ4Kx4GHFlU6VZWI7F4ob8dzO7CTRzdARwq1nf9y6lL7Q5XOu0QG6oLOC8EgwseOkgom928WdQ'
  },
  {
    name: 'Velvet Rose',
    category: 'Floral',
    ...
    <div className="space-y-8">
      <div className="mb-10">
        ...
        <p className="max-w-2xl text-sm text-on-surface-variant">
          Here is the high-level overview of AURA's performance today. The gallery is performing
          steadily.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div className="rounded-xl bg-surface-container-lowest p-8 shadow-[0_8px_30px_rgba(0,0,0,0.02)] lg:col-span-2">
          <div className="mb-6 flex items-center justify-between">
            ...
            <div className="flex space-x-2 text-xs">
              ...
              <span className="cursor-pointer rounded-full bg-primary px-3 py-1 text-on-primary">
                1M
              </span>
        ...
        <div className="flex h-full flex-col rounded-xl bg-surface-container-lowest p-8 shadow-[0_8px_30px_rgba(0,0,0,0.02)]">
          <div className="mb-6 flex items-center justify-between">
            ...
            <span className="material-symbols-outlined cursor-pointer text-sm text-on-surface-variant hover:text-primary">
              more_horiz
            </span>
          </div>
