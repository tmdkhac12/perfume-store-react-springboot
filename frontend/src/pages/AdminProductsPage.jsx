...
const productRows = [
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuARJA5rcznxGf_H0Vjq4S4XYCz18Aop62m_bkKO-_Y11b5wqqb2Jd0j5NMLmGN_8mvj_03rXyF3Vg7Q8lyr0v6xcyZOM0TAcTo0KId0TozPS5u9dKyCuYNZo7dG1zpbuL_TVym2xc02tA04lGljoDGumeqIMWWm8gS0h1C0U7U8I2ehlvVHy_JCSf7YZ5j8W7Bg7zs12UnlHYkeB_bhlzCh5JDakVjZ1UH82l0a7SYmp6nakjkSV-wqIxqMwgljAag227lYTxLIxBc'
  },
  {
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuA4zRS7VKyFwPVYFCVkFGJ8685NaCL_aOkI0YxqzP1FyXWmDSESmLUohRsqX5yvRN2H_sV4Th-rrwy_xPGfHUChGdFjMGXcC1a3id3TeEY_ODUwsmbivj0Y1qeDXXZwUlJffl6vF9c24t_rh3HL_Ckg-HWrxoxhXLldxQV4eETdfYyRyXjAXa7TLn_Y_QhAvLYfTH215pZlc0WE6-PRHiZd4GSlKSizbZ0d2Lht0vmbgY6mfGef9fhlsY-YbnOT_ha-9cceShJpN7A'
  },
  {
    name: 'Gypsy Water',
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAtGUGbKibB9EnDNMdC5j55fn8okzbQcMvW7Uk4fJirXeOZVG7o2zeCyOWzHcfJnN7au2tcmz9Fqu8MoERAl82l_Pvh3rM9NhiukMHkAyYVmk9OY2CX-BwAoJzGHkUFQR0wfnaM0eOraBcrNjr-LK9tFwVOiZggZ3NJ_Kvz0nm2kQv8oqxkA9BPlM4NPZsxik5i9St3Fj_WAIXeGSOnJj98zfIBEgEw5Bnn2nmkM9JlJos4EkWW1JLTSBDMll31eX8grTW9gxfv_KY'
  }
];
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-outline-variant/5">
              {productRows.map((row) => (
                <tr key={row.name} className="group transition-colors hover:bg-surface-container-low/50">
                  <td className="py-4 pl-4">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 flex-shrink-0 overflow-hidden rounded-lg bg-surface-container-low">
                        <img alt={row.name} className="h-full w-full object-cover" src={row.image} />
                      </div>
                      <div>
                        <div className="font-headline font-semibold text-on-surface">{row.name}</div>
